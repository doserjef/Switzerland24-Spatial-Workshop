...
# Get map of the eastern US (east of the 100th meridian)
...
# Note that this takes a decent amount of memory, so there is a chance
...
plot.df <- data.frame(trend = apply(svc.pred.samples[[2]], 2, mean),
                      # Probability the trend is positive at each location.
