# 10a-spatial-glmm-northern-cardinal.R: script to fit a variety of spatial and nonspatial GLMMs
...
#           elevation (elev, both linear and quadratic), precipitation (ppt, linear),
