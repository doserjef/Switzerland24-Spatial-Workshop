...
+ 12:30--13:00 Multi-species spatial occupancy models (Jeff)
+ 14:00--15:30 Multi-species spatial occupancy models (Jeff and exercise)
+ 16:00--17:00 Joint species distribution models with imperfect detection (Jeff)
+ 17:00--17:30 Extra time for discussion, questions, etc.
...
+ 11:00--13:00 Multi-species spatial N-mixture models (Jeff and exercise)
...
All course lectures, code, and exercises can be found [here on the GitHub repository](https://github.com/doserjef/Switzerland24-Spatial-Workshop). Please note that materials are actively be added to the repository and they will not be finalized until immediately before the workshop begins (approx. 21 June or so), so we encourage you to hold off on downloading the course materials until then. 
