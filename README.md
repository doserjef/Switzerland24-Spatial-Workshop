...
- `04b-rock-buntings-occ.R`: **will be added shortly**. A script
  providing a detailed work through of fitting spatial occupancy models
  in `spOccupancy` to predict the distribution of rock buntings in
  Ticino.
